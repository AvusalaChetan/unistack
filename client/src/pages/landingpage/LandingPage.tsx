...
import { Brain, CheckCircle2, File, Moon, Radio, Sun, XCircle } from 'lucide-react';
  ...
  return (
    <main className="h-screen w-screen">
      ...
      >
        ...
        >
          Deploy a bespoke digital campus with zero lines of code. Empower your administration with
          institutional-grade tools while students enjoy a high-performance educational experience.
        </motion.p>
        <motion.div
            ...
            >
              <Card className="relative h-full border-none rounded-none bg-transparent ring-0 py-0 overflow-visible">
                ...
                <CardHeader className="px-0 pt-14 pb-3">
                  <h5 className="text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>
                    {title}
                  </h5>
                </CardHeader>
                <CardDescription
      ...
      >
        <div className="mx-auto max-w-6xl">
          <div className="text-center">
            <h3 className="text-3xl lg:text-5xl font-bold" style={{ color: 'var(--text-primary)' }}>
              Investment Tiers
            </h3>
            <p className="mt-4 text-base lg:text-xl" style={{ color: 'var(--text-secondary)' }}>
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-3 gap-0  items-stretch">
            {pricingPlans.map(
              ({ name, price, unit, dec, cta, featured, points }, index: number) => (
                <motion.div
                  key={name}
                  initial={{ opacity: 0, y: 28 }}
                  whileInView={{ opacity: 1, y: 0 }}
                ...
                >
                  <Card
                    ...
                    style={{
                      backgroundColor: featured ? 'var(--bg-tertiary)' : 'var(--bg-primary)',
